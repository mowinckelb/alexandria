...
s6.addText("$500/month total burn", {
  x: 0.8, y: 1.2, w: 8.4, h: 1.0,
  fontFace: hFont, fontSize: 36, color: C.charcoal,
  align: "left", valign: "bottom", margin: 0,
});
s6.addText("Break-even at ~80 subscribers  \u00b7  Near-zero marginal CAC  \u00b7  89%+ gross margin by Year 2", {
