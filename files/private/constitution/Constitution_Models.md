...
---
**2026-03-13 | strong**
Company identity: humanity as root value, three pillars — freedom, authenticity, purpose. Own it, develop it, use it. Die empty.
...
---
**2026-03-14 | strong**
Bitter lesson as design axiom. "Anything that's a function of intelligence should be maximally a function of model intelligence." The test: is this a values question or an intelligence question? If intelligence, it must not be hard-coded. Extends beyond data format to system architecture, extraction philosophy, and organisational design.

---
**2026-03-15 | strong**
Anchoring and negotiation framing. Set the maximum credible anchor, let them negotiate down, land above where you would have started. Applies beyond fundraising — a general negotiation model.