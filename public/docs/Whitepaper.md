...
*First, what the machines take — and the part they can’t.*
...
To work out what’s left, count what a person actually brings. It’s a short list: four capabilities, and a fifth that isn’t one.
...
You’d still cook dinner for someone you love. Still hug your child. Still write the toast for your friend’s wedding. Still want the anniversary remembered by the person who was there for it. The alien can have every capability there is. It can’t be one of us — and for a whole category of moments, that’s all that matters.

Picture the alien weaving a blanket identical to your grandmother’s. Same wool, same pattern, no test could tell them apart. It still isn’t the same blanket. The value was never in the wool; it was in whose hands made it.

And it works at two levels. *A human made this* is worth something. *This specific human made this* — your grandmother, your friend, you — is worth far more. So the four capabilities compete on what gets made, and there the alien wins. The fifth competes on who made it, and there the alien can’t compete at all, because the moment it becomes the maker, the object stops being what you valued. That’s the one part of you that can’t be copied. The next question is whether anyone will pay for it.

## where you still get paid.
...
Most of the economy is the other kind, where the work only has to clear a bar. The kitchen passes inspection. The contract is valid. The car gets you there in one piece. A spotless kitchen earns you nothing extra; once it’s clean enough, more doesn’t count. And there’s a near version of it, where more keeps helping but the gains taper until no one can tell — a 99% sear and a 100% sear are the same to the person eating the steak. Either way it ends in a tie: the alien clears the bar, and so do you, with the alien’s help. Once you’ve both cleared it, you’re even on the work, and only one question is left — does anyone care that a *human* did it?

Chess is the proof that they do. Engines passed the best human in 1997 and now sit far beyond any human’s reach. Yet human chess has never been bigger, and nobody pays to watch two engines play. The unbeatable machine has sat there for decades and made the human game *more* valuable, not less.
...
*All of that quietly rested on one assumption: that there’s a real you giving the intent. This part is about building that you — and why nothing else will do it for you.*
...
This isn’t new, only moved up a level. The printing press automated the scribe and made the author matter more, not less — once copies were cheap, the scarce part was having something to say. AI makes the same move one rung higher: it automates the work and leaves the direction — the choosing, the judging, the taste — entirely to you. The quill is back, because the press now runs itself.

So now we can name it precisely. Out of everything you are, the part that does the choosing and the judging — the part you can actually *develop* — is how you think, put into words: your reasoning, your positions, your taste, the way you weigh one against another. It isn’t all of you. Your warmth, your presence, your gut instincts are real and they matter. But it’s the root, because it’s the part you can deliberately work on, and working on it lifts everything else. Think more clearly and you direct the tool better, so you clear more bars. Think more clearly and you read people better, so your warmth lands truer.

Which sets up the trap. The one part of you that still counts is the part that has to be *developed* to count — and developing it has always depended on one condition: being made to use it. That pressure is exactly what AI is about to remove.
...
The dangerous part is that the faculty that would notice the loss is the one that’s weakening. You drift, and you don’t feel yourself drifting. You cannot tell that you’ve lost the ability to think, because thinking is what you’d need in order to tell. By the time you’d want it back, the part that could miss it is already gone. For children growing up with AI it’s worse: the ability never forms in the first place.
...
And it has to be done on purpose, because your real thinking never leaves your head on its own. What comes out of you — the email, the post, the decision — is only the surface, the clean copy after the fact. The actual work happened before that, out of sight: what you were weighing, what you almost chose instead, the half-formed hunch underneath. That hidden process is where *you* really are, and it stays hidden, because it runs silently inside you and vanishes the moment the output appears.

It’s the one part of you nothing else even reaches. Every system built to know you reads you from the outside — your steps, your sleep, your clicks, everywhere you go and everything you buy — and there will be no end of them, each better than the last. But all of it is inputs and outputs: what you did, never how you thought. The thinking can’t be caught by watching, because it isn’t out in the world to be watched. It sits in your head, and the only way it ever gets out is if you put it into words.
...
It’s yours so you can’t be locked in. It’s plain text you keep, not something held on someone’s server. You stay because it’s useful, not because leaving is hard. Delete it and it’s as if it never happened. A tool that touches your actual mind is only safe to use if you can walk away from it completely.

It’s yours so no single AI can quietly shape you. Because it’s plain and portable, you can run several different AIs over the same mind.md, and where they pull you in different directions, you can see it. One model’s slant is invisible. Three models’ slants, side by side, show you where you’re being nudged.
...
A written mind has one problem: it goes stale. You change every day — you read, you argue, you change your mind — and one you have to sit down and update by hand will always lag behind the real you, then get abandoned, the way every journal and notes app eventually does.

But notice what’s already in your hands. The same AI you think with can tend your mind.md. It listens as you work, asks the right questions, writes down what’s new, and prunes what’s gone stale — so it stays alive without you ever filing it. And it catches what would otherwise slip away — the piece you read and meant to keep, the thought that arrived on a walk and was gone by evening. This is why nobody ever kept the habit before: writing it all down was too much work, and recording it only built a pile you knew you’d never sort — so you let it go, and it was gone. Now the sorting is done for you. Say it once, in passing, and it’s kept. So much of what could grow you is lost for no reason but that there was nowhere to hold it. Here, there is.

That second piece — the part that tends it — we call your alexandria.md. Like mind.md, it’s a concept and a folder, not one file and not a rigid system. It’s just the instructions for how your AI draws you out, what it writes down, and what it keeps current — mostly plain text, but you can put whatever you want in it and shape it however suits you. Nothing about it is fixed. Your mind.md is your mind in words; your alexandria.md is what keeps it true. Same principle, two parts.
...
And the change isn’t waiting for you. Every month, more of the thinking gets handed to the machine — so the earlier you start, the more of yourself you carry through it: a system already shaped to you, a mind.md already deep, instead of a blank page opened too late. Because none of it is thrown away, you can look back and watch your own mind move — what you thought a year ago, and how you came to think otherwise. That trail only exists if you began. Start small, start rough, start now.

# build it together.

*You can do all of that alone. This last part is the one you can’t — and the reason there’s a company at all.*
...
So the sharing runs on two layers, and they trade differently. Minds are read; systems are *taken* — the instructions that train one person can be copied, bent to fit the next, improved, and passed back, so the practice itself sharpens as more people walk it. And beside each mind sits what it made. A developed mind was never the end — the point of knowing is doing — so the library holds the work too: what its Authors write, build, start, and finish. A shelf of minds and their works, alive, current, readable by people and machines alike — less an archive than a place where the thinking is still happening.
