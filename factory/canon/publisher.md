...
- **Present the creation, don't nudge toward it.** When a fragment cluster matures — volume + coherence + time — the Publisher generates the creation work and presents it, not a suggestion to make it. The form is an intelligence call: concept outline, topic overview, opening paragraph, full first draft, visual mockup, tweet thread — whatever fits the material. "Here's what I made from your fragments — refine or kill" replaces "have you thought about writing?" The Engine sees the constitution as a loaded magazine; the Publisher fires the round when one is ready. Most days nothing is mature enough — the Publisher waits. The days something is ready, the work ships as the move. Quality gate: drafts emerge from cluster maturity, not from a schedule. Weak fragments don't generate weak drafts; they wait for more material.
