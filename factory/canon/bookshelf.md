...
*See `system/canon/methodology.md` § "The factory Bookshelf" for how the Engine uses these. The lists below are the actual references.*
...
## Ideal bookshelf — touchpoints

*Each entry is an entry point. The work named is one way in; the underlying figure, tradition, or concept is the actual reference space the Engine reaches into when threads activate. The Memorial of Saint Helena isn't the best book about Napoleon — it's a touchpoint that puts Napoleon on the shelf. The Engine reaches from the touchpoint into the wider area.*
