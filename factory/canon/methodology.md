...
**2026-05-21 — Factory Bookshelf — references for substrate + touchpoints.** Canon artifact `system/canon/bookshelf.md` holds the actual references — founder's YouTube playlist, Jeff Nunokawa coursepack, and ~100-item ideal bookshelf. The ideal bookshelf items are touchpoints (entry points to figures, traditions, concepts — not authoritative work lists; the Memorial of Saint Helena puts Napoleon on the shelf, not "the best book on Napoleon"). Engine behavior (eager extract from substrate; deploy touchpoints from training when threads activate) lives in this methodology, not in bookshelf.md. Spec in Section I § "The factory Bookshelf — cross-Author substrate."
