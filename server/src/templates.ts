...
<div class="container">
  <div class="section">
    <p class="label">now</p>
    <p class="line"><a class="action" onclick="copyCmd(this)">copy command <span class="icon">${ICON_COPY}</span></a> &mdash; paste in your terminal first</p>
    <p class="line"><a class="action" href="${WEBSITE_URL}/shortcut" target="_blank">add shortcut <span class="icon">${ICON_DOWNLOAD}</span></a> &mdash; share to your vault from your phone</p>
  </div>
  <div class="section">
    ...
    <p class="line">a. &mdash; close the session <span class="info" onclick="toggleTip(this)">${ICON_INFO}<span class="tooltip">closes your /a session. saves everything back — constitution, notepad, machine memory. the compounding happens here.</span></span></p>
  </div>
